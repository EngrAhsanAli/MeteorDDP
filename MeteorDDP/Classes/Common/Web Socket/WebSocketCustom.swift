//
//  WebSocketCustom.swift
//  MeteorDDP
//
//  Created by https://github.com/tidwall/SwiftWebSocket.
//
...
private class Manager {
    ...
    var _nextId = 0
    var timeoutDuration : CFTimeInterval = 30
...
/// WebSocket objects are bidirectional network streams that communicate over HTTP. RFC 6455.
open class WebSocketCustom: NSObject {
    ...
    func setTimeout(_ value: TimeInterval) {
        manager.timeoutDuration = value
    }
...
public func ==(lhs: WebSocketCustom, rhs: WebSocketCustom) -> Bool {
    return lhs.id == rhs.id
}

extension WebSocketCustom {
